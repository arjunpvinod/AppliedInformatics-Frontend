...
export default function HeroComponent() {
  return (
    <div className="bg-[url('./images/bg-1.jpg')] absolute bg-cover top-0 h-auto w-screen">
      <div className="max-w-lg rounded overflow-hidden ml-52 my-48">
