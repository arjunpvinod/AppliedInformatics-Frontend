...
export default function EnquiryComponent() {
  return (
    <div className="bg-[url('./images/bg-2.jpg')] bg-cover bg-no-repeat bg-center bg-no-repeat h-3/5 w-screen px-auto py-14 ">
      ...
      <div className="flex flex-col lg:max-w-md mx-4 lg:mx-auto mt-4">
        ...
        <div className="flex flex-row justify-center w-full">
          <button className="btn btn-primary p-2 my-2 mx-4 rounded-sm text-white font-semibold bg-primary" type="button">
            Send message
          </button>
        </div>
      </div>
